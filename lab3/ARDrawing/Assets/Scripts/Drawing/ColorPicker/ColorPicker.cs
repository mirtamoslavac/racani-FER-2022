...
namespace Drawing.ColorPicker //Microsoft.MixedReality.Toolkit.Experimental.ColorPicker
{
    /// <summary>
    ...
    public class ColorPicker : MonoBehaviour, IMixedRealityTouchHandler
    {
        ...
        public static event EventHandler<Material> MaterialColorChanged;
        ...
        public void SummonColorPicker(GameObject container)
        {
            ...
            TargetObjectMesh = container.GetComponentInChildren<MeshRenderer>();
            TargetObjectSprite = container.GetComponentInChildren<SpriteRenderer>();
        ...
        private void ApplyColor()
        {
            ...
            if (TargetObjectMesh != null && TargetObjectMesh.material != null)
            {
                ...
                if (TargetObjectMesh.transform.parent.name.StartsWith("Left") ||
                    TargetObjectMesh.transform.parent.name.StartsWith("Right"))
                {
                    Material newMaterial = new Material(TargetObjectMesh.material);
                    newMaterial.name = TargetObjectMesh.transform.parent.name.StartsWith("Left") ? "Left" : "Right";
                    MaterialColorChanged?.Invoke(this, newMaterial);
                }
